# Contributing code to ODK Counter
...
1. Once you have completed your code changes, verify that you have followed the [style guidelines](https://github.com/opendatakit/counter/blob/master/CONTRIBUTING.md#style-guidelines). Additionally, [ktlint](https://pinterest.github.io/ktlint/) is run for each new build so please run `gradle lint` and fix any errors before issuing a pull request.
...
1. Run `./gradlew ktlintCheck` and `./gradlew checkstyle` and fix any errors.
